...
namespace offsets
{
	...
	constexpr ptrdiff_t find_hud_element = 0x2FE359D0;
	...
	//not in config
	constexpr ptrdiff_t m_totalRoundsPlayed = 0x64;
	constexpr ptrdiff_t currentRoundDealdDamageTotal = 0x99a8;
	constexpr ptrdiff_t currentRoundHitTimes = 0x99a0;
}