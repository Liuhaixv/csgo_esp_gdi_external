...
namespace offsets
{
    ...
    constexpr ptrdiff_t dwEntityList = 0x4DFFF7C;
    constexpr ptrdiff_t dwForceAttack = 0x322DDE8;
    constexpr ptrdiff_t dwForceAttack2 = 0x322DDF4;
    constexpr ptrdiff_t dwForceBackward = 0x322DE30;
    constexpr ptrdiff_t dwForceForward = 0x322DE24;
    constexpr ptrdiff_t dwForceJump = 0x52BBCD8;
    constexpr ptrdiff_t dwForceLeft = 0x322DDA0;
    constexpr ptrdiff_t dwForceRight = 0x322DDAC;
    constexpr ptrdiff_t dwGameDir = 0x63AD80;
    constexpr ptrdiff_t dwGameRulesProxy = 0x532F4E4;
    constexpr ptrdiff_t dwGetAllClasses = 0xE0BF94;
    constexpr ptrdiff_t dwGlobalVars = 0x59EE60;
    constexpr ptrdiff_t dwGlowObjectManager = 0x535AA08;
    constexpr ptrdiff_t dwInput = 0x525D550;
    constexpr ptrdiff_t dwInterfaceLinkList = 0x99B4A4;
    constexpr ptrdiff_t dwLocalPlayer = 0xDEA98C;
    constexpr ptrdiff_t dwMouseEnable = 0x52391B0;
    constexpr ptrdiff_t dwMouseEnablePtr = 0x5239180;
    constexpr ptrdiff_t dwPlayerResource = 0x322C120;
    constexpr ptrdiff_t dwRadarBase = 0x5236A54;
    constexpr ptrdiff_t dwSensitivity = 0xD039002E;
    constexpr ptrdiff_t dwSensitivityPtr = 0xD0390002;
    constexpr ptrdiff_t dwSetClanTag = 0x8DA80;
    constexpr ptrdiff_t dwViewMatrix = 0x4DF0DC4;
    constexpr ptrdiff_t dwWeaponTable = 0x525E62C;
    constexpr ptrdiff_t dwWeaponTableIndex = 0x326C;
    constexpr ptrdiff_t dwYawPtr = 0xD0390002;
    constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xD0390002;
    constexpr ptrdiff_t dwbSendPackets = 0xDD2B2;
    constexpr ptrdiff_t dwppDirect3DDevice9 = 0xA62C0;
    constexpr ptrdiff_t m_pStudioHdr = 0x2950;
    constexpr ptrdiff_t m_yawClassPtr = 0xD0390002;
    constexpr ptrdiff_t m_pitchClassPtr = 0x52390A8;
    ...
    constexpr ptrdiff_t set_abs_angles = 0x1E7A10;
    constexpr ptrdiff_t set_abs_origin = 0x1E7850;
    constexpr ptrdiff_t is_c4_owner = 0x3E71A0;
    constexpr ptrdiff_t force_update_spectator_glow = 0x3D997A;
    constexpr ptrdiff_t anim_overlays = 0x2990;
    constexpr ptrdiff_t m_flSpawnTime = 0x103C0;
    constexpr ptrdiff_t find_hud_element = 0x2FF402D0;
    ...
    constexpr ptrdiff_t flashedEnemiesNumAtFirstRound = 0x10A54;
    constexpr ptrdiff_t headshotKilledEnemiesAtFirstRound = 0x10874;
    constexpr ptrdiff_t m_iNumRoundKills = 0x99A0;
}